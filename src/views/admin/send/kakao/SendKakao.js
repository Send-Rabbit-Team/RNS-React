                                            ...
                                            <CardBody style={{boxShadow: '1px 2px 9px #8c8c8c'}}>
                                                ...
                                                <FormGroup>
                                                    ...
                                                    <Container>
                                                        <Row>
                                                            <Badge className="badge-md m-1"
                                                                   color="primary">{companyName + "(" + companyKakaoBizId + ")"}</Badge>
                                                        </Row>
                                                    </Container>
                                                </FormGroup>
                                                ...
                                                <FormGroup>
                                                    ...
                                                    <Input
                                                        ...
                                                        type="text"
                                                        onChange={(e) => {
                                                            setMessageSubtitle(e.target.value)
                                                        }}
                                                    ></Input>
                                                </FormGroup>
                                                ...
                                                <FormGroup>
                                                    ...
                                                    >
                                                        ...
                                                        <option value="MD" selected={buttonType === "MD"}>메시지 전달
                                                        </option>
                  ...
                  <span className="btn-inner--icon">
                    <i className="ni ni-send text-white"/>
                                    ...
                                    <Button className="text-lg btn-icon btn-3" size="xxl" color="primary" type="button"
                                            style={{float: "right",}} onClick={(e) => toggleMessageSchedule()}>
                  <span className="btn-inner--icon">
                    <i className="ni ni-time-alarm"/>
                  </span>
